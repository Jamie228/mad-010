...
class TodayEventViewModel(val dataSource: TeacherPlannerDao, application: Application): AndroidViewModel(application) {
    ...
    val events = dataSource.getTodayEvent(nCal.timeInMillis)
